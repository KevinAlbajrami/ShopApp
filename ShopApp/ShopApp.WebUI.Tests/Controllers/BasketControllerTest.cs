...
using ShopApp.WebUI.Tests.Mocks;
...
namespace ShopApp.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanGetSummaryViewModel()
        {
            ...
            Assert.AreEqual(200.00m, BasketSummary.BasketValue);
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            product.Insert(new Product { Id = "2", Price = 10.00m });
            IRepository<Customer> customers = new MockContext<Customer>();
            IRepository<Basket> baskets = new MockContext<Basket>();
            Basket basket = new Basket();
            ...
            customers.Insert(new Customer() { Id = "1", Email = "test@gmail.com", ZipCode = "3402" });
